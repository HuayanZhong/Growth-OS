...
window.EMOTION_SEED = [
  ...
  },
  {
    ...
    anims: [{ target: 'eyes', prop: 'lookX', type: 'sine', amp: 3, period: 6800 }],
  },
  {
    id: '05',
    name: '加载苏醒',
  ...
  },
  {
    ...
    anims: [{ target: 'body', prop: 'rotate', type: 'sine', amp: 1.4, period: 3200 }],
  },
  {
    id: '12',
    name: '失落',
    ...
    anims: [{ target: 'eyes', prop: 'y', type: 'sine', amp: 1.6, period: 3600 }],
  },
  {
    id: '13',
    name: '惊讶',
    ...
    en: {
      name: 'Surprised',
      desc: 'Eyes pop to 1.45x in an instant then steady, the body lifting and freezing',
    },
    transition: 180,
    pool: [3, 21],
    poolMs: [2500, 4000],
  ...
  },
  {
    ...
    anims: [{ target: 'eyes', prop: 'lookX', type: 'sine', amp: 2, period: 2600 }],
    sequence: {
      settle: 'hold',
      frames: [
  ...
  },
  {
    ...
    en: {
      name: 'Tired',
      desc: 'Heavy eyelids at half openness with drowsy rings, gaze sinking low',
    },
    transition: 900,
    pool: [4, 22, 13],
    poolMs: [4000, 8000],
    ...
    anims: [{ target: 'eyes', prop: 'open', type: 'sine', amp: 0.06, period: 3400 }],
  },
  {
    id: '16',
    name: '专注',
    ...
    en: {
      name: 'Focused',
      desc: 'Focused ring family rotates, eyes converge slightly, body almost motionless',
    },
    transition: 320,
    pool: [7, 16, 11, 10],
    poolMs: [1800, 3200],
  ...
  },
  {
    ...
    en: {
      name: 'Satisfied',
      desc: 'Gazing straight ahead while the eyes nod up and down in steady approval',
    },
    transition: 580,
    pool: [15, 8, 2],
    poolMs: [3500, 6000],
  ...
  },
  {
    ...
    en: {
      name: 'Confused',
      desc: 'Mismatched eye sizes and sidelong rings, the two gazes never quite aligning',
    },
    transition: 480,
    pool: [14, 5, 8],
    poolMs: [2200, 3800],
  ...
  },
  {
    ...
    en: {
      name: 'Angry',
      desc: 'Glaring eyes; the face flushes red within a quarter second and stays, body trembling',
    },
    transition: 260,
    pool: [7, 16],
    poolMs: [2200, 3800],
    ...
    anims: [{ target: 'body', prop: 'x', type: 'jitter', amp: 1.1, speed: 7 }],
    sequence: {
      settle: 'hold',
      frames: [
        { at: 0, body: { color: '#F3F0EA' } },
...

  {
    ...
    anims: [{ target: 'eyes', prop: 'lookX', type: 'sine', amp: 9, period: 2600 }],
  },
  {
    id: '31',
    name: '接收任务',
    ...
    en: {
      name: 'Receiving',
      desc: 'A quick blink and slight enlargement, like a nod of acknowledgement',
    },
    transition: 220,
    pool: [19, 0, 8],
    poolMs: [4000, 8000],
  ...
  },
  {
    ...
    en: {
      name: 'Busy',
      desc: 'Focused rings rotate while the gaze loops in tight little circuits',
    },
    transition: 360,
    pool: [7, 16, 11, 10],
    poolMs: [1800, 3200],
  ...
  },
  {
    ...
    en: {
      name: 'Error',
      desc: 'Wide rings as the face flashes red and white, settling on alarm red',
    },
    transition: 220,
    pool: [3, 21],
    poolMs: [2000, 3600],
    ...
    anims: [{ target: 'eyes', prop: 'lookX', type: 'jitter', amp: 1.4, speed: 8, decay: 800 }],
    sequence: {
      settle: 'hold',
      frames: [
  ...
  },
  {
    ...
    en: {
      name: 'Listening',
      desc: 'Listening rings rotate while the gaze sweeps gently up and down',
    },
    transition: 480,
    pool: [10, 1, 19],
    poolMs: [2800, 5000],
    blinkMs: [3000, 7000],
    body: { breathe: 0.01 },
    anims: [{ target: 'eyes', prop: 'lookY', type: 'sine', amp: 6, period: 2200 }],
  },
  {
    id: '36',
    name: '联网加载',
    ...
    en: {
      name: 'Loading',
      desc: 'Eyes blink in alternation, like a signal hopping between two endpoints',
    },
    transition: 380,
    pool: [0, 8],
    poolMs: [6000, 10000],
  ...
  },
  {
    ...
    en: {
      name: 'Recalling',
      desc: 'Listening rings rotate slowly as the gaze drifts upward, leafing through memory',
    },
    transition: 780,
    pool: [10, 1, 19],
    poolMs: [4000, 8000],
    ...
    anims: [{ target: 'eyes', prop: 'lookY', type: 'sine', amp: 2.4, period: 4000 }],
  },
  {
    id: '38',
    name: '拒绝/受限',
    ...
    en: {
      name: 'Refusing',
      desc: 'A lowered sidelong gaze with a firm head-shake on entry: the answer is no',
    },
    transition: 380,
    pool: [14, 5, 23],
    poolMs: [2600, 4500],
  ...
  },
  {
    ...
    en: {
      name: 'Replying',
      desc: 'Reading rings rotate with a gentle pulse that keeps time with the output',
    },
    transition: 360,
    pool: [15, 9],
    poolMs: [4000, 8000],
  ...
  },
  {
    ...
    en: {
      name: 'Searching',
      desc: 'Six reading rings rotate at high speed while the gaze sweeps rapidly side to side',
    },
    transition: 320,
    pool: [15, 9, 3, 20, 12, 18],
    poolMs: [1000, 1800],
    poolSpeed: 10,
    blinkMs: [1600, 4000],
    body: { breathe: 0.006 },
    anims: [{ target: 'eyes', prop: 'lookX', type: 'scan', amp: 11, period: 700 }],
  },
  {
    id: '41',
    name: '停止终止',
